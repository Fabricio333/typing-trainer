...
(function (TT) {
  ...
  var DICT = {
    en: {
      ...
      'tour.punctuation': 'include punctuation in generated word tests.',
      'tour.numbers': 'include numbers in generated word tests.',
      'tour.time': 'type until the selected timer runs out.',
      'tour.words': 'type a fixed number of words.',
      'tour.quote': 'practise with a complete quotation.',
      'tour.patterns': 'repeat common key combinations.',
      'tour.hardest': 'drill the words and keys that slow you down.',
      'tour.zen': 'type without a timer or finish line.',
      'tour.value': 'choose the length for this mode.',
      'tour.skip': 'skip',
      'tour.next': 'next',
      'tour.done': 'done',
      ...
      'stats.slowWordsSub': 'Ranked by recent speed per character, so improvement shows without being buried by old attempts. These are what the "hardest words" drill uses.',
      ...
      'th.word': 'word', 'th.wpm': 'wpm', 'th.recentAvg': 'recent avg', 'th.avg': 'avg', 'th.best': 'best',
    ...
    es: {
      ...
      'tour.punctuation': 'incluye puntuación en las pruebas de palabras.',
      'tour.numbers': 'incluye números en las pruebas de palabras.',
      'tour.time': 'escribí hasta que termine el tiempo elegido.',
      'tour.words': 'escribí una cantidad fija de palabras.',
      'tour.quote': 'practicá con una cita completa.',
      'tour.patterns': 'repetí combinaciones comunes de teclas.',
      'tour.hardest': 'practicá las palabras y teclas que te frenan.',
      'tour.zen': 'escribí sin reloj ni línea de llegada.',
      'tour.value': 'elegí la duración para este modo.',
      'tour.skip': 'saltar',
      'tour.next': 'siguiente',
      'tour.done': 'listo',
      ...
      'stats.slowWordsSub': 'Ordenadas por velocidad reciente por carácter, para que la mejora no quede enterrada por intentos viejos. Son las que usa el entrenamiento de "palabras difíciles".',
      ...
      'th.word': 'palabra', 'th.wpm': 'ppm', 'th.recentAvg': 'media reciente', 'th.avg': 'media', 'th.best': 'mejor',
